import { LayoutList, BarChart2, Clock, User } from 'lucide-react'
...
export default function BottomNav() {
  ...
  const tabs = [
    ...
    { id: 'profile' as const, label: 'Profil', icon: <User size={20} /> },
  ]

  return (
    <nav className="fixed bottom-0 left-0 right-0 z-30 bg-[#0d0d1a]/95 backdrop-blur border-t border-white/8">
      <div className="max-w-xl mx-auto flex items-center justify-around px-2 py-3">
        {tabs.map((tab) => (
          <button
            key={tab.id}
